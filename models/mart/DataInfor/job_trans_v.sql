...
SELECT 
  ...
  CASE
        ...
        WHEN SUBSTR(min_wc.JobrWc, 1,6) IN ('PCOTBL') THEN 'Packing Outside Bulk'
        WHEN SUBSTR(min_wc.JobrWc, 1,6) IN ('PCOTCP') THEN 'Packing Outside Consumer Pack'
        WHEN SUBSTR(min_wc.JobrWc, 1,6) IN ('PCOTFT') THEN 'Packing Outside Filter Tip'
