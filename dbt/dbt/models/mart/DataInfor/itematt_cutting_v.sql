...
WHERE item.Item LIKE '5001%'
   OR item.Item LIKE '5002%'
   OR item.Item LIKE '5003%'
   OR item.Item LIKE '5004%'
   OR item.Item LIKE '5005%'
   OR item.Item LIKE '5006%'
   OR item.Item LIKE '5007%'
   OR item.Item LIKE '2024%'
) b
